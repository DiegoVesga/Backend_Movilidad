...
class ciclo_ruta(db.Model):
    ...
    id_ciclo_ruta = db.Column(db.Integer, primary_key= True)
    ...
    def __init__(self, id_ciclo_ruta, id_ciclo, id_ruta):
        self.id_ciclo_ruta = id_ciclo_ruta
...
class ciclo_rutaSchema(ma.Schema):
    class Meta:
        fields = ('id_ciclo_ruta','id_ciclo', 'id_ruta')
